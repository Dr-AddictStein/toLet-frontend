...
const Contact = () => {
  return (
    <div>   <div className="mt-16 lg:px-24">
    <h1 className='text-black font-bold text-4xl text-center'>We Are Available<br /> For You 24/7</h1>
    <p className='text-black font-bold text-center mb-5'>Our online support service is always 24 hours</p>
    <section className="bg-white dark:bg-gray-900">
        <div className=" px-6 py-12 mx-auto flex justify-center">
            <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                <div className="grid grid-cols-2 gap-12 md:grid-cols-2 lg:px-5">
                    ...
                    <div>
                        ...
                        <h2 className="mt-4 text-base font-medium text-black dark:text-white">
                            Phone
                        </h2>
                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            Mon-Fri from 8am to 5pm.
                        </p>
                        <p className="mt-2 text-sm text-black dark:text-blue-400">
                            +1 (555) 000-0000
                        </p>
                    </div>
                </div>
